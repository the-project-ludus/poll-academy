const topicList = [
  { id: 1, description: 'Agile' },
  { id: 2, description: 'CLI' },
  { id: 3, description: 'MarkDown' },
  { id: 4, description: 'GIT' },
  { id: 5, description: 'HTML5' },
  { id: 6, description: 'CSS' },
  { id: 7, description: 'CSS: FLEXBOX' },
  ...
  { id: 16, description: 'JS, ES6' },
  { id: 17, description: 'JS, Jquery' },
  { id: 18, description: 'JS, Error handling' },
  { id: 19, description: 'Bootstrap' },
  { id: 20, description: 'Ajax & fetch' },
